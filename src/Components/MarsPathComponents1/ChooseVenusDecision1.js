...
gsap.registerPlugin(MotionPathPlugin);
   ...
   function ChooseVenusDecision1({ setScreen }) {
      ...
      useGSAP(() => {
         gsap.to("#mars-planet", {
            motionPath: {
              path: "#orbit1", // The first orbit line
              align: "#orbit1",
              alignOrigin: [0.5, 0.5],
              autoRotate: false, 
            },
            repeat: -1, // Infinite loop
            duration: 10, // Time for one full orbit
            ease: "linear",
          });
          ...
          gsap.to("#venus-planet", {
            motionPath: {
              path: "#orbit2", // The second orbit line
              align: "#orbit2",
              alignOrigin: [0.5, 0.5],
              autoRotate: false,
            },
            repeat: -1, // Infinite loop
            duration: 8, // Time for one full orbit
            ease: "linear",
          });
        }, []);
